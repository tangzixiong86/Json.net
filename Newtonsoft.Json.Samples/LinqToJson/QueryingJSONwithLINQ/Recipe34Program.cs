...
namespace Newtonsoft.Json.Samples
{
    ...
    /// Children()  returns the children values of a JObject/JArray as an IEnumerable<JToken> that can then be queried 
    /// with the standard Where/OrderBy/Select LINQ operators.
    /// </summary>
    public static class Recipe34Program
    {
